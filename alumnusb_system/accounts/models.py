...
class alumncsv(models.Model):
	...
	Codigo_Alumn_USB = models.CharField(max_length=50,null=True,blank=True) #pendiente
	Mailing_country = models.CharField(max_length=50,null=True,blank=True)
	Email = models.EmailField(max_length=50,null=True,blank=True, unique=True)
	Mobile = models.CharField(max_length=30,null=True,blank=True)
	Cohorte = models.IntegerField(null=True,blank=True)
	Birthdate = models.DateField(null=True,blank=True)
	Age = models.IntegerField(null=True,blank=True)
	Undergrad_degree = models.CharField(max_length=50,null=True,blank=True)
	Graduate_degree = models.CharField(max_length=50,null=True,blank=True)
	...
	Work_email = models.EmailField(max_length=40,null=True,blank=True)
	...
	Twitter_account = models.CharField(max_length=40,null=True,blank=True)
	Instagram_account = models.CharField(max_length=40,null=True,blank=True)
